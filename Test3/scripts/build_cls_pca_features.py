"""
Build PCA features from FiLM+Spatial MoE CLS embeddings.
...
TRAIN_NPZ = DATA_DIR / "film_smoe_cond_features.npz"
TEST_NPZ = DATA_DIR / "film_smoe_cond_features_test.npz"
TRAIN_OUT = DATA_DIR / "cls_pca_train.csv"
TEST_OUT = DATA_DIR / "cls_pca_test.csv"
